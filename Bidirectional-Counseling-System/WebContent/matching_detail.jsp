...
<link rel="stylesheet" href="css/matching_detail_css.css">
						...
						<div class="col-xs-12 col-sm-9">
							...
							<div class="profile-user-info">
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span>${user_detail.education}</span>
									</div>
								</div>

								<div class="profile-info-row">
									<div class="profile-info-name"> 전공 </div>

									<div class="profile-info-value">
										<span>${user_detail.major}</span>
									</div>
								</div>

								<div class="profile-info-row">
									<div class="profile-info-name"> 영어 </div>

									<div class="profile-info-value">
										<span>TOEIC:${user_detail.toeic}</span>
										<span>TOEFL:${user_detail.toefl}</span>
									</div>
								</div>

								<div class="profile-info-row">
									<div class="profile-info-name"> 제2외국어 </div>

									<div class="profile-info-value">
										<span>HSK:${user_detail.hsk}</span>
										<span>JLPT:${user_detail.jlpt}</span>
									</div>
								</div>
								<div class="profile-info-row">
									<div class="profile-info-name"> 직무 </div>

									<div class="profile-info-value">
										<span>${user_detail.field}</span>
									</div>
								</div>
							</div>
							...
							<div class="profile-user-info">
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span>${user_detail.certification1}</span>
									</div>
								</div>
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span>${user_detail.certification2}</span>
									</div>
								</div>
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span>${user_detail.certification3}</span>
									</div>
								</div>
								<div class="profile-info-row">
									<div class="profile-info-name">
									...
									<div class="profile-info-value">
										<span>${user_detail.certification4}</span>
									</div>
								</div>
							</div>
						</div><!-- /.col -->
